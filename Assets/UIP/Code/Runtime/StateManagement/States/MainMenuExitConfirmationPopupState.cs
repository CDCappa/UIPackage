...
{
    public class MainMenuExitConfirmationPopupState : UIStateBase<MainMenuSceneUIManager>
    {
        public MainMenuExitConfirmationPopupState(MainMenuSceneUIManager uiManager) : base(uiManager, isSubState: true, isTransitionalState: false) { }
